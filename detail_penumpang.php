...
if (isset($_GET['reservation_id'])) {
    $reservasi = $_GET['reservation_id'];
    // Gunakan nilai $reservation_id sesuai kebutuhan
...
if (isset($_POST['submit'])) {
    // Ambil nilai reservation_id dan k_id dari parameter URL
    $reservation_id = $_GET['reservation_id'];
    $k_id = $_GET['k_id'];

    // Mengubah header untuk mengarahkan ke halaman pembayaran.php dengan parameter
    header("Location: pembayaran.php?reservation_id=$reservation_id&k_id=$k_id");
    exit(); // Pastikan untuk keluar dari script setelah mengalihkan header
}
?>
<!DOCTYPE html>
<html>
...
<div class="container">
    <form action="<?php echo $_SERVER['PHP_SELF'] . '?reservation_id=' . $_GET['reservation_id'] . '&k_id=' . $_GET['k_id']; ?>"
          method="POST" class="mt-5">
        <div class="col-md-6 mx-auto centered-card">
            <?php if ($totalpenumpang > 0) { ?>
                <div class="row">
            ...
            <div class="row">
                <div class="card mb-3" style="width: 50rem;">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php echo $totalpenumpang; ?></p>
                    </div>
                </div>
            </div>
